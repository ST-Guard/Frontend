...
FROM servidor s 
    ...
    -- Correção: Usando a tabela associativa para chegar no usuário
    JOIN datacenters_gestores dg ON dg.fk_datacenter = d.idDataCenter
    JOIN usuario u ON u.idUsuario = dg.fk_usuario
